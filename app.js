...
const App = {
    ...
    renderTimetableLayout(mode) {
        ...
        th += `<td style="font-weight:800; font-size:1.05rem;">${tv}</td></tr></tbody></table></div>`;
    ...
    printPDF() {
        ...
        const css = `
            ...
            * { box-sizing: border-box; }
            ...
            .pt-table th, .pt-table td { border:1px solid #e2e8f0; padding:4px 2px; word-break:keep-all; overflow:hidden; }
